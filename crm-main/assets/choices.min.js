          ...
          E = (function () {
            function e(t, i) {
              ...
              if (
                ...
                return (
                  this.config.silent || console.warn("Trying to initialise Choices on element already initialised", { element: t }),
            ...
            return (
              ...
              (e.prototype.highlightItem = function (e, t) {
                ...
                return (
                  ...
                  t && this.passedElement.triggerEvent(d.EVENTS.highlightItem, { id: i, value: o, label: c, groupValue: h && h.value ? h.value : null }),
                  this
                );
              }),
              (e.prototype.unhighlightItem = function (e) {
                ...
                return (
                  ...
                  this.passedElement.triggerEvent(d.EVENTS.highlightItem, { id: t, value: r, label: a, groupValue: c && c.value ? c.value : null }),
                  this
                );
              }),
              ...
              (e.prototype._addChoice = function (e) {
                ...
                if (null != t) {
                  ...
                  this._store.dispatch(
                    (0, a.addChoice)({ id: y, groupId: h, elementId: E, value: t, label: _, disabled: c, customProperties: d, placeholder: f, keyCode: v })
                  ),
              ...
              (e.prototype._addPredefinedChoices = function (e) {
                ...
                e.forEach(function (e, s) {
                  ...
                  if (t._isSelectElement)
                    ...
                    t._addChoice({ value: o, label: a, isSelected: !!e.selected, isDisabled: !!e.disabled, placeholder: !!e.placeholder, customProperties: c });
                });
              }),
          ...
          r = (function () {
            ...
            return (
              ...
              (e.prototype.shouldFlip = function (e) {
                ...
                var t = !1;
                return (
                  "auto" === this.position ? (t = !window.matchMedia("(min-height: ".concat(e + 1, "px)")).matches) : "top" === this.position && (t = !0), t
                );
              }),
        ...
        var i = (function () {
          ...
          return (
            ...
            (e.prototype.hide = function () {
              return (
                this.element.classList.remove(this.classNames.activeState), this.element.setAttribute("aria-expanded", "false"), (this.isActive = !1), this
              );
            }),
            e
          );
        ...
        var i = {
          ...
          choice: function (e, t, i) {
            var n,
              ...
              E = Object.assign(
                ...
                (((n = { id: v })[s ? "innerHTML" : "innerText"] = f), (n.className = "".concat(o, " ").concat(a)), n)
              );
            return (
              _ && E.classList.add(l),
              y && E.classList.add(u),
          ...
          notice: function (e, t, i) {
            ...
            return (
              ...
              Object.assign(document.createElement("div"), (((n = {})[s ? "innerHTML" : "innerText"] = t), (n.className = h.join(" ")), n))
            );
          },
          option: function (e) {
            var t = e.label,
              ...
              const {
                ...
                for (let n = 0; n < h; n += 1) {
                  let r = 0,
                    a = I;
                  for (; r < a; )
                    y(t, { errors: n, currentLocation: d + a, expectedLocation: d, distance: s, ignoreLocation: l }) <= p ? (r = a) : (I = a),
